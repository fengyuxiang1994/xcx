...
Page({
  ...
  onUpdata: function(i) {
    var _this = this;
    wx.uploadFile({
      url: 'http://www.xcx.com/api/Opinion/getOpinionImg', //仅为示例，非真实的接口地址
      filePath: _this.data.pics[i],
      name: 'file',
      formData: {
        id: wx.getStorageSync('yijian'),
      },
      success(res) {
        console.log(res)
      }
  ...
  formSubmit: function(e) {
    ...
    wx.request({
      url: 'http://www.xcx.com/api/Opinion/getOpinionAip',
      data: formData,
      header: {
      ...
      success(res) {
        console.log(res)
        // 根据返回意见的user_Id存储图片
        wx.setStorageSync('yijian', res.data.data);
